...
async function guiMailBangTransporter(mailOptions) {
    ...
    try {
        ...
        console.log('✅ [Email] Gửi thành công qua SMTP port 465 SSL');
        return info;
    } catch (err1) {
        console.warn('⚠️ Port 465 thất bại, thử port 587...', err1.message);
    }

    // Fallback cuối: port 587 STARTTLS
    ...
    <body>
        <div class="container">
            ...
            <div class="body-content">
                ...
                <div class="warning">
                    ⚠️ <strong>Lưu ý:</strong> Không chia sẻ mã OTP này cho bất kỳ ai. Mã chỉ có hiệu lực trong vòng 10 phút.
                </div>
            </div>
            <div class="footer">
    ...
    <body>
        <div class="container">
            ...
            <div class="body-content">
                ...
                <div class="warning">
                    ⚠️ <strong>Lưu ý quan trọng:</strong> Tuyệt đối không chia sẻ mã này cho bất kỳ ai. Nếu bạn không thực hiện yêu cầu này, vui lòng bỏ qua email.
                </div>
            </div>
            <div class="footer">
                Trí Kun Laptop // Hệ thống Laptop Gaming, AI PC & Đồ Họa hàng đầu 2026<br>
 ...
 */
export async function guiMailXacNhanDonHang(donHang) {
    ...
    try {
        ...
        console.warn(`⚠️ [Nodemailer FE] Không thể gửi email xác nhận đơn #${maDon}:`, err.message);
        return { thanhCong: false, loi: err.message };
    }
}
