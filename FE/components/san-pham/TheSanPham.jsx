...
export default function TheSanPham({ sanPham, cheDoHienThi = 'luoi', hienThiThanhFlashSale = false }) {
    ...
    if (cheDoHienThi === 'danh_sach') {
        return (
            <div className="group bg-white dark:bg-slate-900 rounded-[20px] p-3.5 sm:p-4 border border-[#E7EDF5] dark:border-slate-800 flex flex-col sm:flex-row items-center gap-4 relative transition-all duration-300 hover:shadow-lg hover:border-[#0052cc]">
                <Link
